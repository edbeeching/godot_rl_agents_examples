...
for EXAMPLE in $EXAMPLE_DIRS; do
    ...
    mkdir examples/$EXAMPLE/build
    $GODOT_BINARY --headless --export "Linux/X11" --path examples/$EXAMPLE/ build/$EXAMPLE/$EXAMPLE.x86_64
    $GODOT_BINARY --headless --export "Windows Desktop" --path examples/$EXAMPLE/ build/$EXAMPLE/$EXAMPLE.exe
